...
(function ($) {
    ...
    var wrapper_5 = $(".skills"); //Fields wrapper
    ...
    var add_custom_Skill = $("#Skills"); //Add button ID
    ...
    var x = 1; //initlal text box count
    $(add_custom_Skill).click(function (e) { //on add input button click
        e.preventDefault();
        if (x < max_fields) { //max input box allowed
            x++; //text box increment
            $(wrapper_5).append('<div class="ls-inputicon-box"><input class="form-control m-tb10 wt-form-control" name="Job_Skills[]" type="text" placeholder="Enter Any Skill"><i class="fs-input-icon fa fa-user"></i><a href="#" class="remove_field"><i class="fa fa-times"></i></a></div>'); //add input box
        }
    });
    ...
    $(wrapper_5).on("click", ".remove_field", function (e) { //user click on remove text
        e.preventDefault(); $(this).parent('div').remove(); x--;
    })

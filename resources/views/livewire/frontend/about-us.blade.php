    ...
    <div class="container">
        ...
        <div class="twm-job-categories-section-2 m-b30">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                ...
                                <a href="{{ route('Frontend.JobListing') }}">Business Development</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                ...
                                <a href="{{ route('Frontend.JobListing') }}">Project Management</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                ...
                                <a href="{{ route('Frontend.JobListing') }}">Content Writer</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                ...
                                <a href="{{ route('Frontend.JobListing') }}">Costomer Services</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                <div class="twm-jobs-available">9,185 Jobs</div>
                                <a href="{{ route('Frontend.JobListing') }}">Finance</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                <div class="twm-jobs-available">3,205 Jobs</div>
                                <a href="{{ route('Frontend.JobListing') }}">Marketing</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                <div class="twm-jobs-available">2,100 Jobs</div>
                                <a href="{{ route('Frontend.JobListing') }}">Design &amp; Art</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="job-categories-block-2 m-b30">
                            ...
                            <div class="twm-content">
                                <div class="twm-jobs-available">1,500 Jobs</div>
                                <a href="{{ route('Frontend.JobListing') }}">Web Development</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="text-center job-categories-btn">
                <a href="{{ route('Frontend.JobListing') }}" class=" site-button">All Categories</a>
            </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="twm-w-process-steps-2">
                                <div class="twm-w-pro-top bg-clr-sky-light bg-sky-light-shadow">
                                    ...
                                    <div class="twm-media">
                                        <span><img src="{{ asset('images/work-process/icon1.png') }}"
                                                alt="icon1"></span>
                                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="twm-w-process-steps-2">
                                <div class="twm-w-pro-top bg-clr-yellow-light bg-yellow-light-shadow">
                                    ...
                                    <div class="twm-media">
                                        <span><img src="{{ asset('images/work-process/icon4.png') }}"
                                                alt="icon1"></span>
                                    </div>
                        ...
                        <div class="col-xl-6 col-lg-6 col-md-6">
                            <div class="twm-w-process-steps-2">
                                <div class="twm-w-pro-top bg-clr-pink-light bg-pink-light-shadow">
                                    ...
                                    <div class="twm-media">
                                        <span><img src="{{ asset('images/work-process/icon3.png') }}"
                                                alt="icon1"></span>
                                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="twm-explore-media-wrap">
                        <div class="twm-media">
                            <img src="{{ asset('images/gir-large.png') }}" alt="">
                        </div>
                    </div>
                </div>

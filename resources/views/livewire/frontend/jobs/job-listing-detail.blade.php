        ...
        <div class="wt-bnr-inr-entry">
            <div class="banner-title-outer">
                <div class="banner-title-name">
                    <h2 class="wt-title">{{ $JobsList->Job_Title }}</h2>
                </div>
            </div>
            <!-- BREADCRUMB ROW -->
                ...
                <div class="col-lg-8 col-md-12">
                    ...
                    <div class="cabdidate-de-info">
                            ...
                            <div class="twm-job-self-info">
                                <div class="twm-job-self-top">
                                    <div class="twm-media-bg">
                                        <img src="{{ $JobsList->company->CMP_Cover ? $JobsList->company->CMP_Cover : asset('images/job-detail-bg.jpg') }}"
                                            alt="#">
                                    ...
                                    <div class="twm-mid-content">
                                        ...
                                        <div class="twm-media">
                                            <img src="{{ $JobsList->company->CMP_Logo ? $JobsList->company->CMP_Logo : asset('images/jobs-company/pic1.jpg') }}"
                                                alt="#">
                                        </div>

                                        <h4 class="twm-job-title">{{ $JobsList->Job_Title }} <span
                                                class="twm-job-post-duration">/ 1 days ago</span></h4>
                                        <p class="twm-job-address"><i
                                                class="feather-map-pin"></i>{{ $JobsList->Job_Address }}
                                        </p>
                                        <div class="twm-job-self-mid">
                                            <div class="twm-job-self-mid-left">
                                                <a href="{{ $JobsList->Job_Website }}"
                                                    class="twm-job-websites site-text-primary">Visit Website</a>
                                                <div class="twm-jobs-amount">Rs.
                                                    {{ number_format(intval($JobsList->Job_Salary)) }}
                                                    <span>/ Month</span>
                                                </div>
                                            </div>
                                            <div class="twm-job-apllication-area">Application ends:
                                                <span class="twm-job-apllication-date">
                                                    {{ date('F d, Y', strtotime($JobsList->Job_EDate)) }}</span>
                                            </div>
                                        </div>

                                        {{-- @if (!empty(Auth::guard('Employer')->user()->id))
                                            @if (!($JobsList->EMP_ID == Auth::guard('Employer')->user()->id))
                                                <div class="twm-job-self-bottom">
                                                    <a class="site-button"
                                                        href="/Jobs/Applied-Jobs/{{ $JobsList->id }}" role="button">
                                                        Apply Now
                                                    </a>
                                                </div>
                                            @endif
                                        ...
                                        <div class="twm-job-self-bottom">
                                            <a class="site-button" href="/Jobs/Applied-Jobs/{{ $JobsList->id }}/{{ $JobsList->EMP_ID }}"
                                                role="button">
                                                Apply Now
                                            </a>
                                        </div>
                        ...
                        <ul class="description-list-2">
                            @forelse ($JobsList->requirements as $req)
                                <li>
                        ...
                        <ul class="description-list-2">
                            @forelse ($JobsList->responsibilites as $req)
                                <li>
                                    <i class="feather-check"></i>
                ...
                <div class="col-lg-4 col-md-12 rightSidebar">
                    ...
                    <div class="side-bar mb-4">
                            ...
                            <div class="twm-s-info2">
                                ...
                                <ul class="twm-job-hilites">
                                    <li>
                                        ...
                                        <span
                                            class="twm-title">{{ date('F d, Y', strtotime($JobsList->created_at)) }}</span>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <span class="twm-title">{{ $JobsList->applicants_count }} Applicants</span>
                                    </li>
                                </ul>
                                <ul class="twm-job-hilites2">
                                    ...
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ date('F d, Y', strtotime($JobsList->created_at)) }}
                                            </div>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ $JobsList->Job_Experience }} Year</div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                                            ...
                                            <div class="twm-s-info-discription">
                                                {{ $JobsList->Job_Qualification }} </div>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="twm-s-info-inner">
                        ...
                        <div class="widget tw-sidebar-tags-wrap">
                            ...
                            <div class="tagcloud">
                                @forelse ($JobsList->skills as $skill)
                                    <a href="javascript:void(0)">{{ $skill->Skills }}</a>
                                @empty
                                @endforelse
                            </div>
                        </div>
                    ...
                    <div class="twm-s-info3-wrap mb-5">
                        <div class="twm-s-info3">
                            <div class="twm-s-info-logo-section">
                                ...
                                <h4 class="twm-title">{{ $JobsList->Job_Title }}</h4>
                            </div>
                            <ul>
                                ...
                                <li>
                                    <div class="twm-s-info-inner">
                                        ...
                                        <div class="twm-s-info-discription">{{ $JobsList->company->CMP_Name }}</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="twm-s-info-inner">
                                        ...
                                        <div class="twm-s-info-discription">{{ $JobsList->company->CMP_Phone }}</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="twm-s-info-inner">
                                        ...
                                        <div class="twm-s-info-discription">
                                            {{ $JobsList->company->CMP_Email }}</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="twm-s-info-inner">
                                        ...
                                        <div class="twm-s-info-discription">
                                            {{ $JobsList->company->CMP_Website }}</div>
                                    </div>
                                </li>
                                <li>
                                    <div class="twm-s-info-inner">
                                        ...
                                        <div class="twm-s-info-discription">
                                            {{ $JobsList->company->CMP_Address }}</div>
                                    </div>
                                </li>

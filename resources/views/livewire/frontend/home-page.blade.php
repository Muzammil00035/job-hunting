...
<div class="twm-home1-banner-section site-bg-gray bg-cover"
    style="background-image:url({{ asset('images/main-slider/slider1/bg1.jpg') }})">
    <div class="row">

        <!--Left Section-->
        <div class="col-xl-6 col-lg-6 col-md-12">
            <div class="twm-bnr-left-section">
                <div class="twm-bnr-title-small">We Have <span class="site-text-primary">208,000+</span>
                    Live Jobs</div>
                <div class="twm-bnr-title-large">Find the <span class="site-text-primary">job</span> that
                    fits your life</div>
                <div class="twm-bnr-discription">Type your keyword, then click search to find your perfect
                    job.</div>
                ...
                <div class="twm-bnr-right-carousel">
                    ...
                    <div class="twm-bnr-blocks-position-wrap">
                        ...
                        <div class="twm-bnr-blocks-3 twm-bnr-blocks-position-3">
                            <div class="twm-pics">
                                <span><img src="{{ asset('images/main-slider/slider1/user/u-1.jpg') }}"
                                        alt=""></span>
                                <span><img src="{{ asset('images/main-slider/slider1/user/u-2.jpg') }}"
                                        alt=""></span>
                                <span><img src="{{ asset('images/main-slider/slider1/user/u-3.jpg') }}"
                                        alt=""></span>
                                <span><img src="{{ asset('images/main-slider/slider1/user/u-4.jpg') }}"
                                        alt=""></span>
                                <span><img src="{{ asset('images/main-slider/slider1/user/u-5.jpg') }}"
                                        alt=""></span>
                                <span><img src="{{ asset('images/main-slider/slider1/user/u-6.jpg') }}"
                                        alt=""></span>
                            </div>
                            <div class="twm-content">
        ...
        <div class="wt-separator-two-part">
            <div class="row wt-separator-two-part-row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 wt-separator-two-part-right">
                    <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry the standard dummy text
                        ever since the when an printer took.</p>
                </div>
                        ...
                        <div class="twm-explore-content">
                            ...
                            <div class="twm-title-large">
                                <h2>Don’t just find. be found
                                    ...
                                    great employers </h2>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry the
                                    standard dummy text ever since the when an printer took.</p>
                            </div>
                            <div class="twm-upload-file">
                                <button type="button" class="site-button">Upload Your Resume <i
            ...
            <div class="twm-jobs-list-wrap">
                <ul>
                        ...
                        <div class="twm-jobs-list-style1 mb-5">
                            ...
                            <div class="twm-mid-content">
                                <a href="job-detail.html" class="twm-job-title">
                                    <h4>Senior Web Designer , Developer <span class="twm-job-post-duration">/ 1 days
                                            ago</span></h4>
                                </a>
                                ...
                                <a href="https://themeforest.net/user/thewebmax/portfolio"
                                    class="twm-job-websites site-text-primary">https://thewebmax.com</a>
                            </div>
                    ...
                    <li>
                        <div class="twm-jobs-list-style1 mb-5">
                            <div class="twm-media">
                                <img src="{{ asset('images/jobs-company/pic2.jpg') }}" alt="#">
                            </div>
                            <div class="twm-mid-content">
                                <a href="job-detail.html" class="twm-job-title">
                                    <h4>Need Senior Rolling Stock Technician<span class="twm-job-post-duration">/ 15
                                            days ago</span></h4>
                                </a>
                                <p class="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                <a href="https://themeforest.net/user/thewebmax/portfolio"
                    ...
                    <li>
                        <div class="twm-jobs-list-style1 mb-5">
                            <div class="twm-media">
                                <img src="{{ asset('images/jobs-company/pic3.jpg') }}" alt="#">
                            </div>
                            <div class="twm-mid-content">
                                <a href="job-detail.html" class="twm-job-title">
                                    <h4 class="twm-job-title">IT Department Manager & Blogger-Entrepenour <span
                                            class="twm-job-post-duration">/ 6 Month ago</span></h4>
                                </a>
                                <p class="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                <a href="https://themeforest.net/user/thewebmax/portfolio"
                                    class="twm-job-websites site-text-primary">https://thewebmax.com</a>
                    ...
                    <li>
                        <div class="twm-jobs-list-style1 mb-5">
                            <div class="twm-media">
                                <img src="{{ asset('images/jobs-company/pic4.jpg') }}" alt="#">
                            </div>
                            <div class="twm-mid-content">
                                <a href="job-detail.html" class="twm-job-title">
                                    <h4 class="twm-job-title">Art Production Specialist <span
                                            class="twm-job-post-duration">/ 2 days ago</span></h4>
                                </a>
                                <p class="twm-job-address">1363-1385 Sunset Blvd Los Angeles, CA 90026, USA</p>
                                <a href="https://themeforest.net/user/thewebmax/portfolio"
                                    class="twm-job-websites site-text-primary">https://thewebmax.com</a>
                    ...
                    <li>
                        <div class="twm-jobs-list-style1 mb-5">
                            <div class="twm-media">
                                <img src="{{ asset('images/jobs-company/pic5.jpg') }}" alt="#">
                            </div>
                            <div class="twm-mid-content">
                                <a href="job-detail.html" class="twm-job-title">
                                    <h4 class="twm-job-title">Recreation & Fitness Worker <span
                            ...
                            <div class="twm-right-content">
                                <div class="twm-jobs-category green"><span class="twm-bg-golden">Temporary</span>
                                </div>
            ...
            <div class="owl-carousel twm-testimonial-1-carousel owl-btn-bottom-center ">
                    ...
                    <div class="twm-testimonial-1">
                        <div class="twm-testimonial-1-content">
                            <div class="twm-testi-media">
                                <img src="{{ asset('images/testimonials/pic-1.png') }}" alt="#">
                            </div>
                            <div class="twm-testi-content">
                                <div class="twm-quote">
                                    <img src="{{ asset('images/quote-dark.png') }}" alt="">
                                </div>
                ...
                <div class="item ">
                    <div class="twm-testimonial-1">
                        <div class="twm-testimonial-1-content">
                            <div class="twm-testi-media">
                                <img src="{{ asset('images/testimonials/pic-2.png') }}" alt="#">
                            </div>
                            <div class="twm-testi-content">
                                <div class="twm-quote">
                                    <img src="{{ asset('images/quote-dark.png') }}" alt="">
                ...
                <div class="item ">
                    <div class="twm-testimonial-1">
                        <div class="twm-testimonial-1-content">
                            <div class="twm-testi-media">
                                <img src="{{ asset('images/testimonials/pic-3.png') }}" alt="#">
                            </div>
                            <div class="twm-testi-content">
                                <div class="twm-quote">
                                    <img src="{{ asset('images/quote-dark.png') }}" alt="">

                    ...
                    <div class="col-xl-3 col-lg-4 col-md-12 rightSidebar m-b30">
                        ...
                        <div class="side-bar-st-1">
                            ...
                            <div class="twm-nav-list-1">
                                <ul>
                                    <li class="@yield('Dashboard')"><a href="{{ route('JobSeeker.Dashboard') }}"><i
                                                class="fa fa-tachometer-alt"></i> Dashboard</a></li>
                                    <li><a class="@yield('AppliedJob')" href="{{ route('Get.Appllied.Jobs') }}"><i
                                                class="fa fa-suitcase"></i>
                                            Applied Jobs</a></li>
                                    {{--                                         <li><a class="@yield('MyResume')" href="{{ route('JobSeeker.Resume') }}"><i class="fa fa-receipt"></i>--}}
                                    {{--                                                My Resume</a></li>--}}
                                    <li><a class="@yield('JobAlert')" href="{{ route('JobSeeker.Job.Alerts') }}"><i
                                                class="fa fa-bell"></i>
                                            Job Alert</a></li>

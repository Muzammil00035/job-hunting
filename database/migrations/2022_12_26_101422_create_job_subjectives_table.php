...
class CreateJobSubjectivesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('job_subjectives', function (Blueprint $table) {
            $table->id();
            $table->text('Sub_Questions')->nullable();
            $table->text('Sub_Answers')->nullable();
    ...
    {
        Schema::dropIfExists('job_subjectives');
    }
}
